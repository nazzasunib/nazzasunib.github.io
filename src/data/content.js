...
export const EVENTS = [
  {
    ...
    cover: 'GUB 2026/1.JPG',
    photos: [
      { src: 'GUB 2026/1.JPG', alt: 'AI and Career Guidance Seminar cover' },
      { src: 'GUB 2026/2.JPG', alt: 'Seminar award presentation' },
      { src: 'GUB 2026/3.JPG', alt: 'Signing event documents' },
      { src: 'GUB 2026/4.JPG', alt: 'Seminar group photo' },
      { src: 'GUB 2026/5.JPG', alt: 'Seminar audience' },
      { src: 'GUB 2026/6.JPG', alt: 'Seminar team photo' },
    ],
    article: {
